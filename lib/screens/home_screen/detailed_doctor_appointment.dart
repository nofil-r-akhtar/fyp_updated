...
class DetailedDoctorAppointment extends StatefulWidget {
  final Appointments appointments;
  const DetailedDoctorAppointment({super.key, required this.appointments});

  @override
  State<DetailedDoctorAppointment> createState() => _DetailedDoctorAppointmentState();
}

class _DetailedDoctorAppointmentState extends State<DetailedDoctorAppointment> {
  @override
